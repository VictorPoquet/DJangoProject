...
def lista_tabla_equipos(continente_param,new_equipo):
    listado_equipos = [
    ...
    if not continente_param == None:
        listado_equipos = list(filter(lambda equipo: equipo['continente'] == continente_param, listado_equipos))

    if new_equipo:
        listado_equipos.append(new_equipo)
...
def listar_equipos_mundial(request):
    ...
    listado_equipos = lista_tabla_equipos(continente_param,new_equipo)
